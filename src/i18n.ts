...
export const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    autoSyncOnFileChangeHint: "为以后的文件监听自动同步功能预留开关（Phase 4 / M12，尚未启用）；同时启用「同步模式=全自动」时也会触发自动同步。",
    viewMarketDiffBeforeUpdate: "Market 更新前查看差异",
  ...
  en: {
    ...
    autoSyncOnFileChangeHint: "Reserved toggle for the Phase 4 / M12 file watcher (not yet active). Auto-sync also fires when Sync mode = Full-auto.",
    viewMarketDiffBeforeUpdate: "Show diff before Market updates",
